<template>
	<view class="content">
		<view class="title">
			...
			<text>
				&ensp;（2）危害国家安全，泄漏国家秘密，颠覆国家政权，破坏国家统一的；\n
			</text>
			<text>
				&ensp;（3）损害国家荣誉和利益的，损害公共利益的；\n
			</text>
			<text>
				&ensp;（4）煽动民族仇恨、民族歧视，破坏民族团结的；\n
			</text>
			<text>
				&ensp;（5）破坏国家宗教政策，宣扬邪教和封建迷信的；\n
			</text>
			<text>
				&ensp;（6）散布谣言，扰乱社会秩序，破坏社会稳定的；\n
			</text>
			<text>
				&ensp;（7）散布淫秽、色情、赌博、暴力、凶杀、恐怖或者教唆犯罪的；\n
			</text>
			<text>
				&ensp;（8）侮辱或者诽谤他人，侵害他人合法权益的；\n
			</text>
			<text>
				&ensp;（9）含有法律、行政法规禁止的其它内容的。\n
			</text>
			<text>
